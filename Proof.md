...
- 64^(1/3) gives us a jump amount of 4, therefore 16 jumps and 4 steps from walking, a WCS of 20.of 8 (64^(1/2))
...
So our WCS scenario is WCS = N^(a) + N^(1-a). If we rewrite this equation as a graph we could then differentiate to find the minimum, and a value of a that most optimizes our algorithm. 
